 ...
 */
export const CONNECT_ONLY_UNARY_PROTO_CONTENT_TYPE =
  protoConnect.contentTypeUnaryProto; // "application/proto";
export const CONNECT_ONLY_UNARY_JSON_CONTENT_TYPE =
  protoConnect.contentTypeUnaryJson; // "application/json";
...
export const GRPC_WEB_WITH_UNARY_PROTO_CONTENT_TYPE =
  protoGrpcWeb.contentTypeProto; // "application/grpc-web+proto";
